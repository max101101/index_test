...
# Install deps
LUAROCKS_CONFIG=.luarocks-config luarocks --lua-version 5.1 install --only-deps --tree ./%{name}-%{version}-%{release}-libs rockspecs/test-scm-1.rockspec
